...
from PrefMoE.peft import PeftModel, TaskType, get_peft_model, PrefMoEMOELoraConfig, WEIGHTS_NAME, set_peft_model_state_dict
...
def train():
    ...
    os.makedirs("data/mmpb_clean", exist_ok=True)
    with open("data/mmpb_clean/task.txt", "w") as t:
